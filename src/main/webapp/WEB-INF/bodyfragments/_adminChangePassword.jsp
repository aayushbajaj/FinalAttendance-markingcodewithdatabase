	...
	<div class="panel panel-default">
		<div class="panel-body">
			<div class="text-center">
				<img class="img-changePassword"
					src="${pageContext.request.contextPath}/resources/images/car-key.png"
					...
					<div class="form-group">
						<s:bind path="oldPassword">
							<div class="input-group">
								<sf:input path="${status.expression}" placeholder="Old Password"
			...
			<div class="form-group">
				<s:bind path="newPassword">
					<div class="input-group">
						<sf:input path="${status.expression}" placeholder="New Password"
							class="form-control" type="password" />
						<font color="red" style="font-size: 13px"><sf:errors
								path="${status.expression}" /></font>
				</s:bind>
